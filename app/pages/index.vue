...
useSeoMeta({
  ...
  description: "Eine entstehende Gemeinschaft für ein ehrliches, liebevolles und naturverbundenes Miteinander. Menschen. Natur. Gemeinschaft. Zukunft.",
  ogTitle: "Die Lichtung · Ein Leben in Annahme und Liebe",
  ogDescription: "Mehr Mensch. Mehr Leben. Eine Lichtung für uns alle.",
  ogType: "website",
  ogLocale: "de_DE",
  ogImage: "https://lichtung.be/images/waldlandschaft.webp",
});
useHead({
  meta: [{ name: "theme-color", content: "#f4efe3" }],
  link: [{ rel: "icon", type: "image/png", href: "/images/lichtung-logo.png" }],
});
